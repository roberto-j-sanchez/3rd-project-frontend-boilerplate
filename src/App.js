      ...
      <div className='App'>
        ...
        <Switch>
          ...
          */}
          ...
          />
          {/* to prevent users from accessing the routes when they are not logged in, we are passing currentUser into the component so we can check there whether it's available there */}
          <Route path='/add-phone' render={ () => <AddPhone currentUser={
            this.state.currentUser } /> } />
